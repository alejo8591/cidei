...
class Command(StaticfilesRunserverCommand):
	...
	def start_grunt(self):
		self.stdout.write('>>>>> Iniciando GruntJS')
		...
		self.stdout.write('>>> Proceso Grunt en el pid {0}'.format(self.grunt_process.pid))

		def kill_grunt_process(pid):
			self.stdout.write('>>> Cerrando Proceso de GruntJS y Django')
